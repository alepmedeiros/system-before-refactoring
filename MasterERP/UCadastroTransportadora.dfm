inherited CadastroTransportadoraForm: TCadastroTransportadoraForm
  Caption = 'CadastroTransportadoraForm'
  ClientHeight = 544
  ClientWidth = 814
  KeyPreview = True
  ExplicitWidth = 820
  ...
  inherited qryCadastro: TSQLQuery
    SQL.Strings = (
      'select * from transportadora where transportadora_id = 0')
  end
